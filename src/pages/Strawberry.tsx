      ...
      <div className="p-6 text-xl font-semibold bg-white   w-[1320px] h-[200px]">
          ...
          <div className="grid grid-cols-3 gap-2 mt-8 ">
                      <div className="h-78 w-80  rounded-lg ml-30 shadow-lg  hover:bg-orange-600 bg-white hover:bg-orange-600 group transition duration-300 ">
                          ...
                          <img src="https://i.pinimg.com/736x/4a/e4/3b/4ae43b1cb5b1e54a2e006ac952970783.jpg" 
                              alt=""  
                          ...
                          <p className="text-gray-800 ml-4  text-lg group-hover:text-white transition">Avocado</p> 
                          <p className="text-orange-600 ml-4 text-lg group-hover:text-white transition">$1.5</p>
                          ...
                          <div className="h-78 w-80  rounded-lg ml-15 shadow-lg  hover:bg-orange-600 bg-white hover:bg-orange-600 group transition duration-300 ">
                              <img src="https://i.pinimg.com/736x/d2/80/e6/d280e6048d95721ca746eb789b0b2d28.jpg" 
                                   alt="" 
                              ...
                              <p className="text-gray-800 ml-4 text-lg group-hover:text-white transition font-pacifico">Mango</p>
                              <p className="text-orange-600 ml-4  text-lg group-hover:text-white transition">$1.0</p>
                          </div>
                          ...
                          <div className="h-78 w-80  rounded-lg   shadow-lg  hover:bg-orange-600 bg-white hover:bg-orange-600 group transition duration-300 ">
                              <img src="https://i.pinimg.com/736x/7a/aa/a5/7aaaa545e00e8a434850e80b8910dd94.jpg" 
                                       alt="" 
                                      className="h-50 w-80 rounded-t-lg object-cover"
                              />
                              <div className="flex items-center gap-2 w-23 px-4 py-2"> 
                              ...
                              <p className="text-gray-800 ml-4 text-lg group-hover:text-white transition">Orange </p>
                              <p className="text-orange-600 ml-4  text-lg group-hover:text-white transition">$1.5</p>
                          </div>
          ...
          <div className="grid grid-cols-3 gap-2 mt-8 ">
                      <div className="h-78 w-80  rounded-lg ml-30 shadow-lg  hover:bg-orange-600 bg-white hover:bg-orange-600 group transition duration-300 ">
                          ...
                          <img src="https://i.pinimg.com/736x/e3/a8/b6/e3a8b6a01cdb33ed4dc859734ac80c84.jpg"     
                              alt=""  
                              className="h-50 w-80  object-cover  rounded-t-lg"
                          />
                              <div className="flex items-center gap-2 w-23 px-4 py-2"> 
                          ...
                          <p className="text-gray-800 ml-4 text-lg group-hover:text-white transition">Bananas</p>
                          <p className="text-orange-600 ml-4 text-lg group-hover:text-white transition">$1.5</p>
                      </div>
                          <div className="h-78 w-80  rounded-lg ml-15 shadow-lg  hover:bg-orange-600 bg-white hover:bg-orange-600 group transition duration-300 ">
                              <img src="https://i.pinimg.com/736x/d7/45/10/d74510ae2fa70b77f36f7647e93e50f0.jpg" 
                                   alt="" 
                                  className="h-50 w-80 rounded-t-lg object-cover "
                              />
                              ...
                              <p className="text-gray-800 ml-4 text-lg group-hover:text-white transition">Strawberry</p>
                              <p className="text-orange-600 ml-4  text-lg group-hover:text-white transition">$2.5</p>
                          </div>
                  
                          <div className="h-78 w-80  rounded-lg   shadow-lg  hover:bg-orange-600 bg-white hover:bg-orange-600 group transition duration-300 ">
                              <img src="https://i.pinimg.com/736x/cd/f1/4c/cdf14cfa5ef897b482f5faeb10aa19c7.jpg" 
                                       alt="" 
                                      className="h-50 w-80 rounded-t-lg object-cover"
                              />
                              <div className="flex items-center gap-2 w-23 px-4 py-2"> 
                              ...
                              <p className="text-gray-800 ml-4 text-lg group-hover:text-white transition">Water Malon</p>
                              <p className="text-orange-600 ml-4  text-lg group-hover:text-white transition">$2.5</p>
                          </div>
